    ...
    public class CreatePaypalSubscriptionCommand : Notifiable<Notification>, ICommand
    {
        ...
        public void Validate()
        {
            AddNotifications(new Contract<CreatePaypalSubscriptionCommand>()
                .Requires()
                .IsGreaterThan(FirstName, 3, "Name.FirstName", "FirstName must be at least 3 characters long")
                .IsGreaterThan(LastName, 3, "Name.LastName", "LastName must be at least 3 characters long")
                .IsLowerThan(FirstName, 3, "Name.FirstName", "FirstName must contain 40 characters")
            );
        }
    }
}